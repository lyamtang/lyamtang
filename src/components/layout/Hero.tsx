    ...
    <section className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div className="container relative z-10 mx-auto max-w-5xl text-center">
        ...
        <motion.div
          ...
          className="mb-4"
        >
          <span className="text-lg text-white/80">Hey there! 👋</span>
        </motion.div>
        ...
        >
          <div className="inline-flex max-w-full flex-nowrap items-center justify-center gap-x-3 overflow-x-auto text-xl text-white/95 sm:text-2xl">
            <span className="shrink-0 whitespace-nowrap text-sm font-medium uppercase text-white/60 sm:text-base">I build as</span>
            <span className="inline-flex shrink-0 items-center justify-center whitespace-nowrap rounded-full border border-primary/50 bg-primary/10 px-4 py-2 shadow-[0_0_24px_-12px_var(--primary)] backdrop-blur-md">
              <RotatingText
                texts={[
                ...
                splitBy="characters"
                mainClassName="inline-flex flex-nowrap whitespace-nowrap text-white [&>span]:flex-nowrap"
        ...
        >
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button
              ...
              className="min-w-[160px] border-white/35 bg-white/5 text-white backdrop-blur-sm hover:bg-white/15 hover:text-white"
            >
              Get in Touch
            </Button>
          </motion.div>
